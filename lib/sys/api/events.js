...
/**
 * Generates work events using the specified input
 * @param {object} input The input object
 * @resolves {object} The output object containing the work events
 * @returns {Promise}
 */
async function generateWorkEvents(input) {
...
/**
 * The API endpoint for generating work events
 *
 * @returns {object} The POST method for the /api/events endpoint
 */
module.exports = function () {
     ...
     * Generates work events using the request body as the input
     */
    e['POST /'] = function (req, res) {
        generateWorkEvents(req.body)
