...
const output = {
    ...
    employee: {
        ...
        income:      2000,
        // The time at which the employee starts work
        work_start:  '09:00',
        // The time at which the employee finishes work
        work_end:    '17:00',
        // The time at which the employee leaves for lunch
        lunch_start: '12:00',
        // The time at which the employee arrives from lunch
        lunch_end:   '13:00',
        // The days on which the employee is at work
        work_days:   [1, 2, 3, 4, 5]
    },
    // The list of generated events
    events:   [
        {date: '01/01/2017', event: 'DAY_OFF', data: {name: 'Personal'}},
        {date: '01/01/2017', time: '12:00', event: 'PAYDAY', data: {amount: 2000, currency: 'EUR'}},

        {date: '02/01/2017', event: 'DAY_OFF', data: {name: 'Personal'}},
        ...
        {date: '03/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},
        ...
        {date: '04/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},
        ...
        {date: '05/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},
        ...
        {date: '08/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},
        ...
        {date: '09/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},

        {date: '10/01/2017', event: 'DAY_OFF', data: {name: 'Lorem Day'}},
        ...
        {date: '11/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},
        ...
        {date: '12/01/2017', time: '17:00', event: 'LEAVES_FROM_WORK'},

        {date: '13/01/2017', event: 'DAY_OFF', data: {name: 'Day off'}},

        {date: '14/01/2017', event: 'DAY_OFF', data: {name: 'Day off'}},
    ]
};